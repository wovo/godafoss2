...
constexpr int number_of_digits( int x ){
   int n = 0;
   while( x > 0 ){
      x = x / 10;
      ++n;
...
template< int N >
constexpr auto immutable_string_from_int (){ //  -> immutable_string< 2 > // number_of_digits( N ) > 
   constexpr int digits = number_of_digits( N );
...
template< int n >
//struct blink : component_name< "blink n=", immutable_simmutable_string_from_int< 12tring_from_int< n >  > { 
